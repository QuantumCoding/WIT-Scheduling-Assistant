...
public class MainMenuScreen extends JPanel implements ActionListener {
	...
	private void postInit() {
		...
		descriptions.put(closeButton, "<HTML>"
			...
			+ "<p>"
				+ "\tLogout and Closes the Application"
			+ "</p>"
			+ "</HTML>");
		...
		descriptions.put(viewButton, "<HTML>"
			...
			+ "<p>"
				+ "Displays the User's Current Schedule graphicly"
			+ "<p>"
		...
		descriptions.put(timePreferneceButton, "<HTML>"
			...
			+ "<p>"
				+ "Allows the User to specify which time periods they prefer to have Classes"
			+ "<p>"
				+ "The application will use this information to present the best possible Schedules"
			+ "<BR><BR><B><font size=+>"
				+ "To use this Tool:"
			+ " </font></B><BR>"
				+ "Move the Preference Slider to the Desired Color"
			+ "<p>"
				+ "Select Areas of the Schedule to fill, by <B>LEFT</B> Clicking and Dragging"
			+ "<p>"
		...
		descriptions.put(registerButton, "<HTML>"
			...
			+ "<p>"
				+ "Allows the User to select classes from the database"
			+ "<p>"
				+ "The application will calculate all Schedules for the selected classes"
			+ "<p>"
				+ "The Schedules will be weighted then Ranked based on different factors"
			+ "<p><BR>"
				+ "User will then be presented with all viable Schedules"
			+ "<p>"
				+ "From here the User can register for the Schedule they like best"
			+ "</p>"
			+ "</HTML>");
	}
